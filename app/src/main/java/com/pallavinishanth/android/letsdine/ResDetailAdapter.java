...
public class ResDetailAdapter extends RecyclerView.Adapter<ResDetailAdapter.ViewHolder>  {
    ...
    public ResDetailAdapter(Context context, ArrayList<DetailPhotos> resPhotos){
    ...
    @Override
    public void onBindViewHolder(ResDetailAdapter.ViewHolder holder, int position) {
    ...
    @Override
    public ResDetailAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
